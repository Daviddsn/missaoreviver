...
(function($) {
    ...
    // Bar Filler
    $('.featured-fund-raised-bar').barfiller({ barColor: '#007aff', duration: 1500 });

    $('.fund-raised-bar-1').barfiller({ barColor: '#007aff', duration: 1500 });
    $('.fund-raised-bar-2').barfiller({ barColor: '#007aff', duration: 1500 });
    $('.fund-raised-bar-3').barfiller({ barColor: '#007aff', duration: 1500 });
    $('.fund-raised-bar-4').barfiller({ barColor: '#007aff', duration: 1500 });
    $('.fund-raised-bar-5').barfiller({ barColor: '#007aff', duration: 1500 });
    $('.fund-raised-bar-6').barfiller({ barColor: '#007aff', duration: 1500 });
